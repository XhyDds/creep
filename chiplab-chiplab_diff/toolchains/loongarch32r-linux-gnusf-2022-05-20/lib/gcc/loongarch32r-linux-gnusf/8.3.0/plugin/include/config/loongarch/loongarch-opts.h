...
#define TARGET_32BIT		  (la_target.isa.base == ISA_BASE_LA32RV100)
...
#define TARGET_ARCH_LOONGARCH32R	  (LARCH_ACTUAL_ARCH == CPU_LOONGARCH32R)
#define TARGET_ARCH_LOONGARCH64	  (LARCH_ACTUAL_ARCH == CPU_LOONGARCH64)
#define TARGET_ARCH_LA464	  (LARCH_ACTUAL_ARCH == CPU_LA464)

#define TARGET_TUNE_LOONGARCH32R	  (LARCH_ACTUAL_TUNE == CPU_LOONGARCH32R)
