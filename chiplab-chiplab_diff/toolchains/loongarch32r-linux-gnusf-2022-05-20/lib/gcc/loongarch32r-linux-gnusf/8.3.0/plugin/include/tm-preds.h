/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/opt/loongarch32r-linux-gnusf-2022-05-20/gcc-8.3.0/src/gcc/config/loongarch/loongarch.md'.  */
...
extern int const_uimm7_operand (rtx, machine_mode);
